...
import (
	...
	alphaAdd "github.com/kyma-project/cli/cmd/kyma/alpha/add"
	"github.com/kyma-project/cli/cmd/kyma/alpha/add/apirule"
...
`,
	...
	add := alphaAdd.NewCmd()
	add.AddCommand(apirule.NewCmd(apirule.NewOptions(o)))
	alphaCmd.AddCommand(add)
